...
<body>
    <header class="main-header">
        ...
        <nav class="navigation-bar">
            <ul>
                <li><a href="dashboard.php">ALL LETTERS</a></li>
        ...
        <table class="display-table">
            ...
            <table>
                ...
                <tr>
                    ...
                    <button type="submit" id="wholeSubmitButton" class= "submit-btn" style="display:none;" onclick="submitForm('submit_whole.php');">SUBMIT</button>
