    ...
    <header class="main-header">
        ...
        <nav class="navigation-bar">
            <ul>
                ...
                <li><a href="outbox.php" style="color: #ff9a9e" >OUTBOX </a></li>
    ...
    <table class="input-group" border="4">
        <thead>
            <tr>
                ...
                <th scope="col"><div align="center"><h2>Marked To</h2></div></th>
        ...
        <tbody>
    <?php
        $sql="Select * from marked_letters where marked_by='$id'";
        ...
        if($result){
            ...
            while($row=mysqli_fetch_assoc($result)){
                ...
                $marked_to=$row['marked_to'];
                $marked_letter_number=$row['marked_letter_number'];
                $q="Select * from adgh where emp_id='$marked_to'";
                $r=mysqli_query($conn, $q);
                $new_row=mysqli_fetch_assoc($r);
                ...
                if($new_row){
                    ...
                    $q="Select * from emp_id where id='$marked_to'";
                    $r=mysqli_query($conn, $q);
                    $new_row=mysqli_fetch_assoc($r);
                    $full_name = trim($new_row['first_name'] . " " . $new_row['middle_name'] . " " . $new_row['last_name']);
                }
                $marked_to_name=$full_name;
            ...
            if ($result1) {
                ...
                if (isset($row1['adgh_id'])) {
                    ...
                    echo '<td><button><a href="mark.php?letter_id='.$marked_letter_id.'" onclick="return confirm(\'Are you sure you want to MARK this item?\')">MARK</a></button></td>';
                }
            
        }}else {
            echo '<td><button><a href="mark_normal_user.php?letter_id='.$marked_letter_id.'" onclick="return confirm(\'Are you sure you want to MARK this item?\')">MARK</a></button></td>';
        }
